 ...
 */
public class V4TimeServersOptionImpl extends com.jagornet.dhcp.xml.impl.IpAddressListOptionTypeImpl implements com.jagornet.dhcp.xml.V4TimeServersOption
{
    private static final long serialVersionUID = 1L;
    
    public V4TimeServersOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
