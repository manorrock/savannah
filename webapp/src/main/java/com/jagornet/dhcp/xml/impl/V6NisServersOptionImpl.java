 ...
 */
public class V6NisServersOptionImpl extends com.jagornet.dhcp.xml.impl.IpAddressListOptionTypeImpl implements com.jagornet.dhcp.xml.V6NisServersOption
{
    private static final long serialVersionUID = 1L;
    
    public V6NisServersOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
