 ...
 */
public class V6NewPosixTimezoneOptionImpl extends com.jagornet.dhcp.xml.impl.StringOptionTypeImpl implements com.jagornet.dhcp.xml.V6NewPosixTimezoneOption
{
    private static final long serialVersionUID = 1L;
    
    public V6NewPosixTimezoneOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
