 ...
 */
public class V6NisPlusServersOptionImpl extends com.jagornet.dhcp.xml.impl.IpAddressListOptionTypeImpl implements com.jagornet.dhcp.xml.V6NisPlusServersOption
{
    private static final long serialVersionUID = 1L;
    
    public V6NisPlusServersOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
