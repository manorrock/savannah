 ...
 */
public class V4MsgTypeOptionImpl extends com.jagornet.dhcp.xml.impl.UnsignedByteOptionTypeImpl implements com.jagornet.dhcp.xml.V4MsgTypeOption
{
    private static final long serialVersionUID = 1L;
    
    public V4MsgTypeOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
