 ...
 */
public class V4HostnameOptionImpl extends com.jagornet.dhcp.xml.impl.StringOptionTypeImpl implements com.jagornet.dhcp.xml.V4HostnameOption
{
    private static final long serialVersionUID = 1L;
    
    public V4HostnameOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
