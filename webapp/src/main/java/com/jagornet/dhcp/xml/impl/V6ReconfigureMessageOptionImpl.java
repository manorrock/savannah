 ...
 */
public class V6ReconfigureMessageOptionImpl extends com.jagornet.dhcp.xml.impl.UnsignedByteOptionTypeImpl implements com.jagornet.dhcp.xml.V6ReconfigureMessageOption
{
    private static final long serialVersionUID = 1L;
    
    public V6ReconfigureMessageOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
