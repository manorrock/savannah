 ...
 */
public class V6ElapsedTimeOptionImpl extends com.jagornet.dhcp.xml.impl.UnsignedShortOptionTypeImpl implements com.jagornet.dhcp.xml.V6ElapsedTimeOption
{
    private static final long serialVersionUID = 1L;
    
    public V6ElapsedTimeOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
