 ...
 */
public class V6RelayMessageOptionImpl extends com.jagornet.dhcp.xml.impl.OpaqueDataOptionTypeImpl implements com.jagornet.dhcp.xml.V6RelayMessageOption
{
    private static final long serialVersionUID = 1L;
    
    public V6RelayMessageOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
