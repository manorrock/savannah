 ...
 */
public class V4ParamRequestOptionImpl extends com.jagornet.dhcp.xml.impl.UnsignedByteListOptionTypeImpl implements com.jagornet.dhcp.xml.V4ParamRequestOption
{
    private static final long serialVersionUID = 1L;
    
    public V4ParamRequestOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
