 ...
 */
public class V6ClientIdOptionImpl extends com.jagornet.dhcp.xml.impl.OpaqueDataOptionTypeImpl implements com.jagornet.dhcp.xml.V6ClientIdOption
{
    private static final long serialVersionUID = 1L;
    
    public V6ClientIdOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
