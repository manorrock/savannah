 ...
 */
public class V6NewTzdbTimezoneOptionImpl extends com.jagornet.dhcp.xml.impl.StringOptionTypeImpl implements com.jagornet.dhcp.xml.V6NewTzdbTimezoneOption
{
    private static final long serialVersionUID = 1L;
    
    public V6NewTzdbTimezoneOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
