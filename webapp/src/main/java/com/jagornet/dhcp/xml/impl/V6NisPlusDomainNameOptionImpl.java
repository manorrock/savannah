 ...
 */
public class V6NisPlusDomainNameOptionImpl extends com.jagornet.dhcp.xml.impl.DomainNameOptionTypeImpl implements com.jagornet.dhcp.xml.V6NisPlusDomainNameOption
{
    private static final long serialVersionUID = 1L;
    
    public V6NisPlusDomainNameOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
