 ...
 */
public class V6ServerUnicastOptionImpl extends com.jagornet.dhcp.xml.impl.IpAddressOptionTypeImpl implements com.jagornet.dhcp.xml.V6ServerUnicastOption
{
    private static final long serialVersionUID = 1L;
    
    public V6ServerUnicastOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
