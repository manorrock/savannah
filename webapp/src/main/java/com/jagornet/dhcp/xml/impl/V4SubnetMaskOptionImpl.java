 ...
 */
public class V4SubnetMaskOptionImpl extends com.jagornet.dhcp.xml.impl.IpAddressOptionTypeImpl implements com.jagornet.dhcp.xml.V4SubnetMaskOption
{
    private static final long serialVersionUID = 1L;
    
    public V4SubnetMaskOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
