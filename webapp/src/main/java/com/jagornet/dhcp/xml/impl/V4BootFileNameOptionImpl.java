 ...
 */
public class V4BootFileNameOptionImpl extends com.jagornet.dhcp.xml.impl.StringOptionTypeImpl implements com.jagornet.dhcp.xml.V4BootFileNameOption
{
    private static final long serialVersionUID = 1L;
    
    public V4BootFileNameOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
