 ...
 */
public class V6LostServerDomainNameOptionImpl extends com.jagornet.dhcp.xml.impl.DomainNameOptionTypeImpl implements com.jagornet.dhcp.xml.V6LostServerDomainNameOption
{
    private static final long serialVersionUID = 1L;
    
    public V6LostServerDomainNameOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
