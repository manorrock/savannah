 ...
 */
public class V6DomainSearchListOptionImpl extends com.jagornet.dhcp.xml.impl.DomainNameListOptionTypeImpl implements com.jagornet.dhcp.xml.V6DomainSearchListOption
{
    private static final long serialVersionUID = 1L;
    
    public V6DomainSearchListOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
