 ...
 */
public class V4TftpServerNameOptionImpl extends com.jagornet.dhcp.xml.impl.StringOptionTypeImpl implements com.jagornet.dhcp.xml.V4TftpServerNameOption
{
    private static final long serialVersionUID = 1L;
    
    public V4TftpServerNameOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
