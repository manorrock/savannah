 ...
 */
public class V6EchoRequestOptionImpl extends com.jagornet.dhcp.xml.impl.UnsignedShortListOptionTypeImpl implements com.jagornet.dhcp.xml.V6EchoRequestOption
{
    private static final long serialVersionUID = 1L;
    
    public V6EchoRequestOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
