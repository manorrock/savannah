 ...
 */
public class V4RequestedIpAddressOptionImpl extends com.jagornet.dhcp.xml.impl.IpAddressOptionTypeImpl implements com.jagornet.dhcp.xml.V4RequestedIpAddressOption
{
    private static final long serialVersionUID = 1L;
    
    public V4RequestedIpAddressOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
