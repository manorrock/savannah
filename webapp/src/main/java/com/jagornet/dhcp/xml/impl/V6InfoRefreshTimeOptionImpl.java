 ...
 */
public class V6InfoRefreshTimeOptionImpl extends com.jagornet.dhcp.xml.impl.UnsignedIntOptionTypeImpl implements com.jagornet.dhcp.xml.V6InfoRefreshTimeOption
{
    private static final long serialVersionUID = 1L;
    
    public V6InfoRefreshTimeOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
