 ...
 */
public class V6PreferenceOptionImpl extends com.jagornet.dhcp.xml.impl.UnsignedByteOptionTypeImpl implements com.jagornet.dhcp.xml.V6PreferenceOption
{
    private static final long serialVersionUID = 1L;
    
    public V6PreferenceOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
