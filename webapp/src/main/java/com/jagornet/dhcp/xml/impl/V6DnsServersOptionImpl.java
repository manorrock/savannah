 ...
 */
public class V6DnsServersOptionImpl extends com.jagornet.dhcp.xml.impl.IpAddressListOptionTypeImpl implements com.jagornet.dhcp.xml.V6DnsServersOption
{
    private static final long serialVersionUID = 1L;
    
    public V6DnsServersOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
