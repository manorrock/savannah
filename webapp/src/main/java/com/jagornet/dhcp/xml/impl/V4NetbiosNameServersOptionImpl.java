 ...
 */
public class V4NetbiosNameServersOptionImpl extends com.jagornet.dhcp.xml.impl.IpAddressListOptionTypeImpl implements com.jagornet.dhcp.xml.V4NetbiosNameServersOption
{
    private static final long serialVersionUID = 1L;
    
    public V4NetbiosNameServersOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
