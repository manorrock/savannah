 ...
 */
public class V6NisDomainNameOptionImpl extends com.jagornet.dhcp.xml.impl.DomainNameOptionTypeImpl implements com.jagornet.dhcp.xml.V6NisDomainNameOption
{
    private static final long serialVersionUID = 1L;
    
    public V6NisDomainNameOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
