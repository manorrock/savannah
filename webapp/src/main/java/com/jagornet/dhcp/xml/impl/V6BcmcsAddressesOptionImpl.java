 ...
 */
public class V6BcmcsAddressesOptionImpl extends com.jagornet.dhcp.xml.impl.IpAddressListOptionTypeImpl implements com.jagornet.dhcp.xml.V6BcmcsAddressesOption
{
    private static final long serialVersionUID = 1L;
    
    public V6BcmcsAddressesOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
