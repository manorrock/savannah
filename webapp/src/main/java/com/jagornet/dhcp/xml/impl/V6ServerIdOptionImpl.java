 ...
 */
public class V6ServerIdOptionImpl extends com.jagornet.dhcp.xml.impl.OpaqueDataOptionTypeImpl implements com.jagornet.dhcp.xml.V6ServerIdOption
{
    private static final long serialVersionUID = 1L;
    
    public V6ServerIdOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
