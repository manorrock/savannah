 ...
 */
public class V4NetbiosNodeTypeOptionImpl extends com.jagornet.dhcp.xml.impl.UnsignedByteOptionTypeImpl implements com.jagornet.dhcp.xml.V4NetbiosNodeTypeOption
{
    private static final long serialVersionUID = 1L;
    
    public V4NetbiosNodeTypeOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
