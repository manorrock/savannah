 ...
 */
public class V6SntpServersOptionImpl extends com.jagornet.dhcp.xml.impl.IpAddressListOptionTypeImpl implements com.jagornet.dhcp.xml.V6SntpServersOption
{
    private static final long serialVersionUID = 1L;
    
    public V6SntpServersOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
