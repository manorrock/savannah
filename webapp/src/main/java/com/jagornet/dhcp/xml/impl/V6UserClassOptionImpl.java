 ...
 */
public class V6UserClassOptionImpl extends com.jagornet.dhcp.xml.impl.OpaqueDataListOptionTypeImpl implements com.jagornet.dhcp.xml.V6UserClassOption
{
    private static final long serialVersionUID = 1L;
    
    public V6UserClassOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
