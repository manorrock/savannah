 ...
 */
public class V4ServerIdOptionImpl extends com.jagornet.dhcp.xml.impl.IpAddressOptionTypeImpl implements com.jagornet.dhcp.xml.V4ServerIdOption
{
    private static final long serialVersionUID = 1L;
    
    public V4ServerIdOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
