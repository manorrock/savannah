 ...
 */
public class V4DomainNameOptionImpl extends com.jagornet.dhcp.xml.impl.StringOptionTypeImpl implements com.jagornet.dhcp.xml.V4DomainNameOption
{
    private static final long serialVersionUID = 1L;
    
    public V4DomainNameOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
