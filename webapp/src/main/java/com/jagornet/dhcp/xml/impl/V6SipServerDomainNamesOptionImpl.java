 ...
 */
public class V6SipServerDomainNamesOptionImpl extends com.jagornet.dhcp.xml.impl.DomainNameListOptionTypeImpl implements com.jagornet.dhcp.xml.V6SipServerDomainNamesOption
{
    private static final long serialVersionUID = 1L;
    
    public V6SipServerDomainNamesOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
