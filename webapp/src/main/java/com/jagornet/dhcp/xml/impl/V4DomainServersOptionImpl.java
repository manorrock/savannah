 ...
 */
public class V4DomainServersOptionImpl extends com.jagornet.dhcp.xml.impl.IpAddressListOptionTypeImpl implements com.jagornet.dhcp.xml.V4DomainServersOption
{
    private static final long serialVersionUID = 1L;
    
    public V4DomainServersOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
