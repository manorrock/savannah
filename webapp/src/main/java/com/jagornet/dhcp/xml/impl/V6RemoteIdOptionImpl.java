 ...
 */
public class V6RemoteIdOptionImpl extends com.jagornet.dhcp.xml.impl.OpaqueDataOptionTypeImpl implements com.jagornet.dhcp.xml.V6RemoteIdOption
{
    private static final long serialVersionUID = 1L;
    
    public V6RemoteIdOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
