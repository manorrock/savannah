 ...
 */
public class V6BcmcsDomainNamesOptionImpl extends com.jagornet.dhcp.xml.impl.DomainNameListOptionTypeImpl implements com.jagornet.dhcp.xml.V6BcmcsDomainNamesOption
{
    private static final long serialVersionUID = 1L;
    
    public V6BcmcsDomainNamesOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
