 ...
 */
public class V4ClientIdOptionImpl extends com.jagornet.dhcp.xml.impl.OpaqueDataOptionTypeImpl implements com.jagornet.dhcp.xml.V4ClientIdOption
{
    private static final long serialVersionUID = 1L;
    
    public V4ClientIdOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
