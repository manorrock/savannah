 ...
 */
public class V4RoutersOptionImpl extends com.jagornet.dhcp.xml.impl.IpAddressListOptionTypeImpl implements com.jagornet.dhcp.xml.V4RoutersOption
{
    private static final long serialVersionUID = 1L;
    
    public V4RoutersOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
