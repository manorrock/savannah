 ...
 */
public class V4TimeOffsetOptionImpl extends com.jagornet.dhcp.xml.impl.UnsignedIntOptionTypeImpl implements com.jagornet.dhcp.xml.V4TimeOffsetOption
{
    private static final long serialVersionUID = 1L;
    
    public V4TimeOffsetOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
