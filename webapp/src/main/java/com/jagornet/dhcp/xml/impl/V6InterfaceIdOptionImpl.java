 ...
 */
public class V6InterfaceIdOptionImpl extends com.jagornet.dhcp.xml.impl.OpaqueDataOptionTypeImpl implements com.jagornet.dhcp.xml.V6InterfaceIdOption
{
    private static final long serialVersionUID = 1L;
    
    public V6InterfaceIdOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
