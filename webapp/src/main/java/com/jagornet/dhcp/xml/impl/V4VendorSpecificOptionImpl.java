 ...
 */
public class V4VendorSpecificOptionImpl extends com.jagornet.dhcp.xml.impl.OpaqueDataOptionTypeImpl implements com.jagornet.dhcp.xml.V4VendorSpecificOption
{
    private static final long serialVersionUID = 1L;
    
    public V4VendorSpecificOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
