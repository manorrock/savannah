 ...
 */
public class V6OptionRequestOptionImpl extends com.jagornet.dhcp.xml.impl.UnsignedShortListOptionTypeImpl implements com.jagornet.dhcp.xml.V6OptionRequestOption
{
    private static final long serialVersionUID = 1L;
    
    public V6OptionRequestOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
