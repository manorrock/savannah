 ...
 */
public class V6PanaAgentAddressesOptionImpl extends com.jagornet.dhcp.xml.impl.IpAddressListOptionTypeImpl implements com.jagornet.dhcp.xml.V6PanaAgentAddressesOption
{
    private static final long serialVersionUID = 1L;
    
    public V6PanaAgentAddressesOptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
